    ...
    <div className='dark-bg-report'>
      <div className="centered">
        <div className="modal">
          ...
          <div className="form">
            <textarea className='message' name="message" id="" cols="30" rows="10" placeholder='Write your report'></textarea>
            <div className="buttons">
              <button className='buttons-report button-report'>Report</button>
              <button className='buttons-report button-close' onClick={() => setOpenModalReport(false)}>Close</button>
            </div>
          </div>
        </div>
      </div>
